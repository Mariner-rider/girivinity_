"""Multi-agent orchestration with task routing and shared memory."""
...
class Agent(Protocol):
    ...
    def run(self, task: str, memory: SharedMemory, hidden_scratchpad: list[str]) -> AgentResult:
        ...
...
class AgentController:
    ...
    def route_task(self, task: str) -> list[Agent]:
        ...
        if "quick" in lowered:
            route = [self.reasoning_agent, self.critic_agent]
